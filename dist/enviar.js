...
var CSVInput = ({ onSubmit }) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, { flexDirection: "column", borderStyle: "round", borderColor: "cyan", padding: 1 }, /* @__PURE__ */ React.createElement(Text, { color: "green" }, "Arraste seu CSV aqui ou digite o caminho:"), /* @__PURE__ */ React.createElement(Box, null, /* @__PURE__ */ React.createElement(Text, { color: "yellow" }, input)), error && /* @__PURE__ */ React.createElement(Text, { color: "red" }, error));
};

// enviar.js
var App = () => {
  const [step, setStep] = useState2("input");
  const [csvPath, setCsvPath] = useState2(null);
  ...
  if (step === "error") {
    return /* @__PURE__ */ React2.createElement(Box2, null, /* @__PURE__ */ React2.createElement(Text2, { color: "red" }, "\u274C Erro: ", error));
  }
  return null;
};
